...
$status_filter = 'Pending DKA';  

$id_karyawan = $_SESSION['id_user'] ?? 0;
$nama = $_SESSION['nama'] ?? 'Admin DKA';
?>

<!DOCTYPE html>
<html lang="id">
<head>
    <title>EVORIA | Dashboard DKA</title>
    ...
    <div class="main-content">
        <div class="header-dka">
            ...
            <div>
                <span class="me-3">
                    ...
                    <?= $nama ?>
                    <span class="badge bg-danger ms-2">DKA</span>
                </span>
        ...
        <div class="content-area">
            <?php 
                ...
                } elseif ($page == 'mahasiswa_create') {
                    include 'Mahasiswa/create.php';
                } elseif ($page == 'mahasiswa_update') {
                    include 'Mahasiswa/update.php';
                } elseif ($page == 'mahasiswa_delete') {
                    include 'Mahasiswa/delete.php';
                } 
                elseif ($page == 'venue') {
                    include 'Venue/index.php';
                } elseif ($page == 'venue_create') {
                    include 'Venue/create.php';
                } elseif ($page == 'venue_update') {
                    include 'Venue/update.php';
                } elseif ($page == 'venue_delete') {
                    include 'Venue/delete.php';
                } 
                // ========== KARYAWAN ==========
                elseif ($page == 'karyawan') {
                    include 'Karyawan/index.php';
                } elseif ($page == 'karyawan_create') {
                    include 'Karyawan/create.php';
                } elseif ($page == 'karyawan_update') {
                    include 'Karyawan/update.php';
                } elseif ($page == 'karyawan_delete') {
