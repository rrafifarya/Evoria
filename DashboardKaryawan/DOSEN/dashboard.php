...
if($_SESSION['role'] != 'Sekprodi' && $_SESSION['role'] != 'Kaprodi') {
...
$status_filter = 'Pending Sekprodi/Kaprodi';

$id_karyawan = $_SESSION['id_user'] ?? 0;
$nama_admin = $_SESSION['nama'] ?? 'Dosen';
$jabatan = $_SESSION['role'] ?? 'Dosen';
?>

<!DOCTYPE html>
<html lang="id">
<head>
    <title>EVORIA | Dashboard Dosen</title>
        ...
        <div class="header-dosen">
            ...
            <div>
                <span class="me-3">
                    ...
                    <?= $nama_admin ?>
                    <span class="badge bg-info ms-2"><?= $jabatan ?></span>
                </span>
